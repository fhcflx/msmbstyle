...
To achieve this we use the `kable()` function to produce the an HTML table with the attributes `margintab` & `marginnote`.  **pinkstyle** then provides the CSS required to place this table in the margin.
